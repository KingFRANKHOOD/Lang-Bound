...
pub trait IQuiz<TContractState> {
    ...
    fn set_question(ref self: TContractState, quiz_id: u32, question_id: u32, text: felt252, options: LegacyMap::<u8, felt252>, correct_option: u8);
    ...
    fn answer_question(self: @TContractState, quiz_id: u32, question_id: u32, participant: ContractAddress, selected_option: u8) -> bool;
}
...
mod quiz_contract {
    ...
    struct Quiz {
        title: felt252,
        description: felt252,
        questions: LegacyMap::<u32, Question>,
        total_questions: u32,
    }
    ...
    struct Question {
        ...
        correct_option: u8,
        is_answered: LegacyMap::<ContractAddress, bool>,
    }
...
impl quiz_contract {
    ...
    fn add_question(self: @ContractState, quiz_id: u32, question_id: u32, text: felt252, options: LegacyMap::<u8, felt252>, correct_option: u8) {
        self.storage.set_question(quiz_id, question_id, text, options, correct_option);
    }

    fn submit_answer(self: @ContractState, quiz_id: u32, question_id: u32, participant: ContractAddress, selected_option: u8) -> bool {
